...
import com.example.LifeCo.fragments.ChatsFragment;
import com.example.LifeCo.fragments.ProfileFragment;
import com.example.LifeCo.fragments.UsersFragment;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                ...
                startActivity(new Intent(ChatMainActivity.this, StartActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                return true;
        }
        return false;
    }
