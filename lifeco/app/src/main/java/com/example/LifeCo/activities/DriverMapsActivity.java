...
//                    List<Object> passengerLocationMap = new ArrayList<Object>(passengerLocHMap.values());
                    ...
                    PickUpLocationMarker = mMap.addMarker(new MarkerOptions().position(PassengerLatLng).title("Pickup Location").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher)));
